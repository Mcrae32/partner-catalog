...
$(document).ready(function () {
	...
	$('.spoiler-title').click(function () {
		const spoilerBlock = $(this).closest(".spoiler-block");
		spoilerBlock.find('div.spoiler-content').toggle('fast');
		spoilerBlock.find('span.button-spoiler').toggleClass("active");
		spoilerBlock.find('.spoiler-title span').toggleClass("active");
		return false;
	});
